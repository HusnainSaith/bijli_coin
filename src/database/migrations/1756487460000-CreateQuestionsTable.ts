  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.createTable(new Table({
      ...
      columns: [
        ...
        { name: "status", type: "enum", enum: ["open", "closed", "archived"], isNullable: true },
      ...
      foreignKeys: [
        ...
        { columnNames: ["category_id"], referencedTableName: "categories", referencedColumnNames: ["id"], onDelete: "SET NULL" }
      ]
    }), true);

    await queryRunner.query('CREATE INDEX "IDX_questions_user_id" ON "questions" ("user_id")');
    await queryRunner.query('CREATE INDEX "IDX_questions_category_id" ON "questions" ("category_id")');
  }
