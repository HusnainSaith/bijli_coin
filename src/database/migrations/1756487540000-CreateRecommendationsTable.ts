...
export class CreateRecommendationsTable1756487540000
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'CREATE INDEX "IDX_recommendations_recommendable" ON "recommendations" ("recommendable_type", "recommendable_id")',
    );
  }
