...
export class CreateAuthorFollowersTable1756487500000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.createTable(new Table({
      ...
      foreignKeys: [
        ...
        { columnNames: ["author_id"], referencedTableName: "users", referencedColumnNames: ["id"], onDelete: "CASCADE" }
      ]
    }), true);

    await queryRunner.query('CREATE INDEX "IDX_author_followers_follower_id" ON "author_followers" ("follower_id")');
    await queryRunner.query('CREATE INDEX "IDX_author_followers_author_id" ON "author_followers" ("author_id")');
  }
