  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.createTable(new Table({
      ...
      foreignKeys: [
        ...
        { columnNames: ["media_id"], referencedTableName: "media", referencedColumnNames: ["id"], onDelete: "CASCADE" }
      ]
    }), true);

    await queryRunner.query('CREATE INDEX "IDX_post_media_post_id" ON "post_media" ("post_id")');
    await queryRunner.query('CREATE INDEX "IDX_post_media_media_id" ON "post_media" ("media_id")');
  }
